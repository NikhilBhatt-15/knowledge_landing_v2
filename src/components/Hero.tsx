        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              See the Stories History Skipped
            </motion.h1>

            <motion.p
              className="text-base md:text-lg text-gray-200 mb-6 italic"
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
              transition={{ duration: 0.8, delay: 0.35 }}
            >
              Free to explore • Pro unlocks the full story
            </motion.p>
            ...
            >
              Know[ledge] is a free app with short stories and timelines that add context to culture, identity, and history—revealing what’s often left out.
            </motion.div>
