        ...
        >
          <div className="py-4 space-y-4 border-t border-[#D4E333]/20">
            ...
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <button className="w-full bg-gradient-to-r from-[#D4E333] to-[#CFABFA] hover:from-[#D4E333]/90 hover:to-[#CFABFA]/90 text-[#242B7A] font-semibold border-0 rounded-full px-6 py-2 transition-all duration-300">
                Download
              </button>
            </motion.div>
          </div>
